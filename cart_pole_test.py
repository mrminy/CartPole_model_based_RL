...
import numpy as np
from my_actor_critic import ActorCriticLearner as my_actor_critic_learner
...
class ActorCriticLearner:
    def __init__(self, env, max_episodes, episodes_before_update, discount):
        self.env = env
        self.actor = Actor(self.env, discount)
    ...
    def learn(self, max_env_time_steps, goal_avg_score):
        ...
        for i in range(self.max_episodes):
            ...
            for e in range(len(episode_states)):
                state_action_history.append([episode_states[e], episode_actions[e], episode_next_states[e]])
